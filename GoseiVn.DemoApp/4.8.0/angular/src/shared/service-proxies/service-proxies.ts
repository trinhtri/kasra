...
export class EstimateServiceProxy {
    ...
    /**
     * @param listImage (optional) 
     * @return Success
     */
    createImageWhenEditEstimate(listImage: CreateImageDto[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Estimate/CreateImageWhenEditEstimate";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(listImage);
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateImageWhenEditEstimate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateImageWhenEditEstimate(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateImageWhenEditEstimate(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getImageAfterUploadWhenEditEstimate(estimateId: number | null | undefined): Observable<CreateImageDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Estimate/GetImageAfterUploadWhenEditEstimate?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetImageAfterUploadWhenEditEstimate(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetImageAfterUploadWhenEditEstimate(<any>response_);
                } catch (e) {
                    return <Observable<CreateImageDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateImageDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetImageAfterUploadWhenEditEstimate(response: HttpResponseBase): Observable<CreateImageDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(CreateImageDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<CreateImageDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    getEstimateToExcel(firstname: string | null | undefined, lastName: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<FileDto> {
        let url_ = this.baseUrl + "/api/services/app/Estimate/GetEstimateToExcel?";
        if (firstname !== undefined)
            url_ += "Firstname=" + encodeURIComponent("" + firstname) + "&"; 
        if (lastName !== undefined)
            url_ += "LastName=" + encodeURIComponent("" + lastName) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetEstimateToExcel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetEstimateToExcel(<any>response_);
                } catch (e) {
    ...
    protected processGetEstimateToExcel(response: HttpResponseBase): Observable<FileDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getDataForEdit(id: number | null | undefined): Observable<CreateEstimateDto> {
        let url_ = this.baseUrl + "/api/services/app/Estimate/GetDataForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetDataForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetDataForEdit(<any>response_);
                } catch (e) {
                    return <Observable<CreateEstimateDto>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetDataForEdit(response: HttpResponseBase): Observable<CreateEstimateDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteImageByIdWhenEdit(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Estimate/DeleteImageByIdWhenEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteImageByIdWhenEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteImageByIdWhenEdit(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteImageByIdWhenEdit(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class EstimateExcelExporterServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    exportToFile(estimates: EstimateListForExcelDto[] | null | undefined): Observable<FileDto> {
        ...
        const content_ = JSON.stringify(estimates);
